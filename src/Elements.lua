--==============================================================================
-- ScorpioX Modern Elements Engine (Premium Dark/Neon UI - STABLE VERSION)
--==============================================================================
...
--------------------------------------------------------------------------
-- DROPDOWN IBRIDO (FIXATO E OTTIMIZZATO)
--------------------------------------------------------------------------
    ...
    local function createOptionButton(optionText)
        ...
        opt.Activated:Connect(function()
            ...
            if isMultiSelect then
                -- FIXATO: Inversione dello stato booleano esplicita per evitare strutture corrotte
